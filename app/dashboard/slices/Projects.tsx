...
interface ProjectsSliceProps {
  ...
  setProjectTab: React.Dispatch<React.SetStateAction<"logs" | "settings" | "project">>;
  projectTab: "logs" | "settings" | "project";
}
                ...
                <div>
                  <Popover>
                    ...
                    >
                      ...
                      ></PopoverDescription>
                      <div className="mt-4 border-t flex flex-col border-zinc-800 pt-4">
                        <button
